%clear all
%close all
function get_subnetwork_movieParc_v2(EN,dd,bl)
...
mkdir(['./' netprefix 'subnetworks_movieparc' appendix '/'])
disp(['./' netprefix 'subnetworks_movieparc' appendix '/'])
save(['./' netprefix 'subnetworks_movieparc' appendix '/all_subnetworks.mat'],'all_subnetworks','class_labels','all_subnet_labels')
