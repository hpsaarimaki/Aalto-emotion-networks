function make_network_fun_v2(s,delay,block_length)
...
%for s=1:Nsubj
	...
	for run=1:Nruns
        ...
        for storyblock=1:7
           ...
           outfile=['./networks_' num2str(delay) '_' num2str(block_length)  '/' 'net_subj' num2str(s) '_' story_labels{storyID} '_id' num2str(storyID) '.mat'];
