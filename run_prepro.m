...
nSubs = 16;
[subjects,subjects_out] = makefiles(dataroot,nSubs)
...
%% Drifter settings
cfg.drifter = 1; % 1 if you have biopac measurements
cfg.driftermode = 1; % 0 = BOLD estimate only, 1 = BOLD+residual added back
...
cfg.detrend_type='Savitzky-Golay';   % detrending type, other option is to set this to 'Savitzky-Golay'
